...
public abstract class AbstractPartitionedHdfsBolt extends BaseRichBolt {
	private static final Logger LOG = LoggerFactory.getLogger(AbstractPartitionedHdfsBolt.class);

	protected Map<String, AbstractExportManager> currentFiles = new HashMap<>();
